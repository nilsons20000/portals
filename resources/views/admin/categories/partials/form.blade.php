...
<div class="rtq">
	<label for="">Nosaukums</label><span class="required">*</span>
	<input type="text" class="form-control" name="title" placeholder="Kategorijas virsraksts" value="{{$category->title ?? ""}}" required>
</div>

<div class="rtq">
	<label for="">Slug</label>
	<input class="form-control" type="text" name="slug" placeholder="Automatiska ģenerācija" value="{{$category->slug ?? ""}}" readonly="">
</div>
